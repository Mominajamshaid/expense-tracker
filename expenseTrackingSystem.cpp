...
public:
    ...
    void showHighestExpense() {
        if (head == nullptr) {
            cout << "No expenses available to evaluate.\n";
            return;
        }

        ExpenseNode* temp = head;
        ExpenseNode* highest = head;
        ...
        cout << "\nHighest Expense:\n";
        cout << "Description: " << highest->description << " | Amount: $" << highest->amount << "\n";
    }
};
